    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
          ...
          <p>
            Le mariage entre un chihuahua de la variété poil court et un chihuahua de la variété
            poil long n'étant pas autorisé par le Mexique, pays détenteur du standard, le CCCE a
            demandé et obtenu l'accord de la Commission d'élevage de la SCC ainsi que celui du
            Comité de la SCC en 2006 pour mettre en place une politique d'élevage sous le contrôle
            du Club contribuant à l'amélioration de la race.
          </p>
